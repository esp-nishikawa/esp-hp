      ...
      items: [
        {
          ...
          title: 'エントランス',
          duration: 1.0,
          rotate: this.$helpers.getRandom(2, 6),
          scale: 1.10,
        ...
        },
        {
          ...
          title: 'ラウンジ',
          duration: 1.6,
          rotate: this.$helpers.getRandom(-10, -6),
          scale: 1.16,
        ...
        },
        {
          ...
          title: 'ワークスペース',
          duration: 1.4,
          rotate: this.$helpers.getRandom(-8, 8),
          scale: 1.14,
        ...
        },
        {
          ...
          title: '会議室',
          duration: 1.2,
          rotate: this.$helpers.getRandom(-6, -2),
          scale: 1.12,
        ...
        },
        {
          ...
          title: 'ライブラリー',
          duration: 1.8,
          rotate: this.$helpers.getRandom(6, 10),
          scale: 1.18,
